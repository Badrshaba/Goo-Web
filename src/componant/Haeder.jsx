...
const searchResults = (e)=>{
  ...
  <div className=" divHover" onMouseLeave={() => setShow(false)} >
  <div
            ...
            >
              <div className="text-black position-absolute bg-white divCart">
                {cart.length}
              </div>
             ...
             {cart&& show&& (
                <div className="position-absolute hoverDiv p-2 bg-white">
                  <p className=" fs-6 pt-1 text-black-50 text-center mb-2">
...
<Link to={"/cart"}><button  className="bg-success border-0  text-white p-2 m-1 pe-4 ps-4">View My Shopping Cart</button></Link>
</div>
</>
:
<>
